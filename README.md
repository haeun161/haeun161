...
Currently, I'm delving into **Generative AI (GA)**.
...
|--------|-------------|---------------------------|--------|
| `2025.08 ~ 2026.09` | Statistical Artificial Intelligence Lab, KAIST | - Generative Models(Diffusion, LLM) | - 1 Paper Accepted in ICML2026 (https://icml.cc/virtual/2026/poster/63627) <br> - TBD (Diffusion Research) |
...
| `2022.11 ~ 2024.01` | Convergence Security Engineering Lab, Sungshin Women's Univ. | - **Topic**: Artificial Intelligence and Information Protection Convergence | - Main Paper Presentation: *Lightweight Federated Learning* (Mobisec, Int’l Conf.) <br> - Poster Presentation: *EDR Automation using Generative AI (VAE)* (Mobisec, Int’l Conf.) <br> - Submitted to **KCI-indexed journal** <br> - Patent: *Smart control apparatus and method*, Korea, No. 10-2024-00599425 |
