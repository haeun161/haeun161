...
|--------|-------------|---------------------------|--------|
| `2025.08 ~ ` | Statistical Artificial Intelligence Lab, KAIST | - Generative Models(Diffusion, LLM) | - 1 Paper Accepted in ICML2026(https://icml.cc/virtual/2026/poster/63627) |
